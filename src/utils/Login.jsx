...
export default function Login({ onSwitchForm }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Add your backend authentication fetch call here
  };
  ...
  return (
    <div style={styles.card}>
      ...
      <p style={styles.switchText}>
        ...
        <span onClick={onSwitchForm} style={styles.link}>Sign Up</span>
      </p>
    </div>
  );
}

// Inherits the styling dictionary used in Signup.jsx
const styles = {
  card: {
    background: '#fff',
    padding: '40px',
  ...
  input: { padding: '10px 14px', borderRadius: '6px', border: '1px solid #ccc', fontSize: '16px' },
  button: {
    padding: '12px',
    background: '#007bff',
    color: '#fff',
