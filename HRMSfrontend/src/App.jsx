...
import useDarkMode from './hooks/useDarkMode.js'; // Import our new hook
...
export default function App() {
  ...
  const handleExport = () => {
    ...
    setTimeout(() => {
      setExporting(false);
      alert('Data exported successfully! (Mock Event)');
    }, 1200);
  };
  ...
  return (
    <div className="flex h-screen bg-[#f4f6fa] dark:bg-slate-950 font-sans text-slate-800 dark:text-slate-100 overflow-hidden transition-colors duration-200">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {/* ================= VIEW CONTAINER ================= */}
        <main className="flex-1 overflow-y-auto p-6 bg-[#f4f6fa] dark:bg-slate-950 transition-colors duration-200">
          {currentView === 'Dashboard' ? (
            <div className="space-y-6 max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2 rounded-xl border border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm flex flex-col justify-between transition-colors">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm font-bold text-slate-900 dark:text-white">Training costs</h3>
